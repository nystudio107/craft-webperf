<template>
    <div>
        <div v-if="parsedErrors">
            <div v-if="type === 'craft'">
                <h4 class="text-red-dark m-0">Craft Errors:</h4>
            ...
            <div v-else-if="type === 'boomerang'">
                <h4 class="text-green-dark m-0">JavaScript Errors:</h4>
                <div v-for="message in parsedErrors">
                    <div class="field text-sm font-normal inline-block pt-2">
                        ...
                        <p class="m-0 text-grey-darker">
                            Stack Trace &rarr;
                            <ul class="list-reset">
                                <li v-for="item in message.f" class="text-grey-darker pl-2">
